...
public class CoffeeMessage implements ServiceOutput {

	private String SERVICE_URL = TickerConstants.TICKER_SERVER_BASE_URL + "/coffee";
...
//					System.out.println(output);
		...
		if (response != null && response.length() > 0) {
			...
			message = "{RTL}                    Last Pot of Coffee Brewed: ";
			message += text;
			message += "                              ";
		}
